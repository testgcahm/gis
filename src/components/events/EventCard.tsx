...
const EventCard = ({ event, onDetails, onShare, onRegister, copied }: EventCardProps) => (
  <motion.div
  ...
  >
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="bg-white/80 p-4 flex flex-col justify-between leading-normal flex-grow">
        ...
        <div className={`flex flex-row ${onRegister? 'max-[540px]:flex-col': 'max-[430px]:flex-col'} items-start justify-between gap-4`}>
          ...
          <div className={`flex gap-2 flex-shrink-0 w-auto ${onRegister ? 'max-[540px]:w-full max-[540px]:justify-center' : 'max-[430px]:w-full max-[430px]:justify-center'} max-[350px]:flex-col max-[350px]:w-full`}>
            ...
            {onRegister && (
              <button onClick={onRegister} className="max-w-[120px] max-[350px]:max-w-full w-full bg-secondary hover:bg-secondary/80 text-white font-bold px-4 py-2 rounded-lg shadow-sm transition-all duration-200 focus:outline-none">Register</button>
            )}
            <button
